  ...
  return (
    <div className="aurora-grid flex h-[calc(100vh-56px)] bg-paper">
      ...
      <div className="flex-1 overflow-hidden p-3 sm:p-5">
        ...
        <div className="h-full overflow-hidden rounded-[1.5rem] border border-white/60 bg-surface shadow-xl shadow-indigo-950/10 dark:border-white/10"><ChatInterface key={selectedSession?.id || 'new'} initialSession={selectedSession} /></div>
      </div>
    </div>
  );
}
